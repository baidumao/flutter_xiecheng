...
class ScalesBox extends StatelessWidget {
  ScaleBoxModel salesBox;

  ScalesBox(this.salesBox); //salesBox数据
    ...
    return GestureDetector(
      child: Container(
       decoration: BoxDecoration(
        ...
        child: CachedImage(imageUrl: model.icon,
        fit: BoxFit.fill,
      ...
      onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (context){
              return WebView(url: model.url,statusBarColor: model.statusBarColor,title: model
                .title,hideAppBar: model.hideAppBar);
            }));
      },
    );
 }
